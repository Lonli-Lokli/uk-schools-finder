...
export const metadata = {
  ...
  description:
    'Find the best schools in the UK to help choose your next family home. Compare schools, explore neighborhoods, and make informed decisions about where to live based on education quality.',
  openGraph: {
    title: 'UK Schools Finder - Find Perfect Schools for Your Family',
    description:
      'Find the best schools in the UK to help choose your next family home. Compare schools, explore neighborhoods, and make informed decisions about where to live based on education quality.',
