...
export const KS5DestinationsSchema = z.object({
  ...
  // Total cohort disadvantaged students
  TOT_COHORT_DIS: mustBeNumber(),
  TOT_OVERALL_DIS: mustBeNumber(),
  TOT_APPREN_DIS: mustBeNumber(),
  TOT_EDUCATION_DIS: mustBeNumber(),
  TOT_FE_DIS: mustBeNumber(),
  TOT_HE_DIS: mustBeNumber(),
  TOT_OTHER_EDU_DIS: mustBeNumber(),
  TOT_EMPLOYMENT_DIS: mustBeNumber(),
  TOT_NOT_SUSTAINED_DIS: mustBeNumber(),
  TOT_NOT_CAPTURED_DIS: mustBeNumber(),
  TOT_OVERALLPER_DIS: mustBePercentage(),
  TOT_APPRENPER_DIS: mustBePercentage(),
  TOT_EDUCATIONPER_DIS: mustBePercentage(),
  TOT_FEPER_DIS: mustBePercentage(),
  TOT_HEPER_DIS: mustBePercentage(),
  TOT_OTHER_EDUPER_DIS: mustBePercentage(),
  TOT_EMPLOYMENTPER_DIS: mustBePercentage(),
  TOT_NOT_SUSTAINEDPER_DIS: mustBePercentage(),
  TOT_NOT_CAPTUREDPER_DIS: mustBePercentage(),

  // Total cohort non-disadvantaged students
  TOT_COHORT_NONDIS: mustBeNumber(),
  TOT_OVERALL_NONDIS: mustBeNumber(),
  TOT_APPREN_NONDIS: mustBeNumber(),
  TOT_EDUCATION_NONDIS: mustBeNumber(),
  TOT_FE_NONDIS: mustBeNumber(),
  TOT_HE_NONDIS: mustBeNumber(),
  TOT_OTHER_EDU_NONDIS: mustBeNumber(),
  TOT_EMPLOYMENT_NONDIS: mustBeNumber(),
  TOT_NOT_SUSTAINED_NONDIS: mustBeNumber(),
  TOT_NOT_CAPTURED_NONDIS: mustBeNumber(),
  TOT_OVERALLPER_NONDIS: mustBePercentage(),
  TOT_APPRENPER_NONDIS: mustBePercentage(),
  TOT_EDUCATIONPER_NONDIS: mustBePercentage(),
  TOT_FEPER_NONDIS: mustBePercentage(),
  TOT_HEPER_NONDIS: mustBePercentage(),
  TOT_OTHER_EDUPER_NONDIS: mustBePercentage(),
  TOT_EMPLOYMENTPER_NONDIS: mustBePercentage(),
  TOT_NOT_SUSTAINEDPER_NONDIS: mustBePercentage(),
  TOT_NOT_CAPTUREDPER_NONDIS: mustBePercentage(),
  ...
  // Level 2 disadvantaged students
  L2_COHORT_DIS: mustBeNumber(),
  L2_OVERALL_DIS: mustBeNumber(),
  L2_APPREN_DIS: mustBeNumber(),
  L2_EDUCATION_DIS: mustBeNumber(),
  L2_FE_DIS: mustBeNumber(),
  L2_HE_DIS: mustBeNumber(),
  L2_OTHER_EDU_DIS: mustBeNumber(),
  L2_EMPLOYMENT_DIS: mustBeNumber(),
  L2_NOT_SUSTAINED_DIS: mustBeNumber(),
  L2_NOT_CAPTURED_DIS: mustBeNumber(),
  L2_OVERALLPER_DIS: mustBePercentage(),
  L2_APPRENPER_DIS: mustBePercentage(),
  L2_EDUCATIONPER_DIS: mustBePercentage(),
  L2_FEPER_DIS: mustBePercentage(),
  L2_HEPER_DIS: mustBePercentage(),
  L2_OTHER_EDUPER_DIS: mustBePercentage(),
  L2_EMPLOYMENTPER_DIS: mustBePercentage(),
  L2_NOT_SUSTAINEDPER_DIS: mustBePercentage(),
  L2_NOT_CAPTUREDPER_DIS: mustBePercentage(),

  // Level 2 non-disadvantaged students
  L2_COHORT_NONDIS: mustBeNumber(),
  L2_OVERALL_NONDIS: mustBeNumber(),
  L2_APPREN_NONDIS: mustBeNumber(),
  L2_EDUCATION_NONDIS: mustBeNumber(),
  L2_FE_NONDIS: mustBeNumber(),
  L2_HE_NONDIS: mustBeNumber(),
  L2_OTHER_EDU_NONDIS: mustBeNumber(),
  L2_EMPLOYMENT_NONDIS: mustBeNumber(),
  L2_NOT_SUSTAINED_NONDIS: mustBeNumber(),
  L2_NOT_CAPTURED_NONDIS: mustBeNumber(),
  L2_OVERALLPER_NONDIS: mustBePercentage(),
  L2_APPRENPER_NONDIS: mustBePercentage(),
  L2_EDUCATIONPER_NONDIS: mustBePercentage(),
  L2_FEPER_NONDIS: mustBePercentage(),
  L2_HEPER_NONDIS: mustBePercentage(),
  L2_OTHER_EDUPER_NONDIS: mustBePercentage(),
  L2_EMPLOYMENTPER_NONDIS: mustBePercentage(),
  L2_NOT_SUSTAINEDPER_NONDIS: mustBePercentage(),
  L2_NOT_CAPTUREDPER_NONDIS: mustBePercentage(),
  ...
  // Other levels disadvantaged students
  LALLOTH_COHORT_DIS: mustBeNumber(),
  LALLOTH_OVERALL_DIS: mustBeNumber(),
  LALLOTH_APPREN_DIS: mustBeNumber(),
  LALLOTH_EDUCATION_DIS: mustBeNumber(),
  LALLOTH_FE_DIS: mustBeNumber(),
  LALLOTH_HE_DIS: mustBeNumber(),
  LALLOTH_OTHER_EDU_DIS: mustBeNumber(),
  LALLOTH_EMPLOYMENT_DIS: mustBeNumber(),
  LALLOTH_NOT_SUSTAINED_DIS: mustBeNumber(),
  LALLOTH_NOT_CAPTURED_DIS: mustBeNumber(),
  LALLOTH_OVERALLPER_DIS: mustBePercentage(),
  LALLOTH_APPRENPER_DIS: mustBePercentage(),
  LALLOTH_EDUCATIONPER_DIS: mustBePercentage(),
  LALLOTH_FEPER_DIS: mustBePercentage(),
  LALLOTH_HEPER_DIS: mustBePercentage(),
  LALLOTH_OTHER_EDUPER_DIS: mustBePercentage(),
  LALLOTH_EMPLOYMENTPER_DIS: mustBePercentage(),
  LALLOTH_NOT_SUSTAINEDPER_DIS: mustBePercentage(),
  LALLOTH_NOT_CAPTUREDPER_DIS: mustBePercentage(),

  // Other levels non-disadvantaged students
  LALLOTH_COHORT_NONDIS: mustBeNumber(),
  LALLOTH_OVERALL_NONDIS: mustBeNumber(),
  LALLOTH_APPREN_NONDIS: mustBeNumber(),
  LALLOTH_EDUCATION_NONDIS: mustBeNumber(),
  LALLOTH_FE_NONDIS: mustBeNumber(),
  LALLOTH_HE_NONDIS: mustBeNumber(),
  LALLOTH_OTHER_EDU_NONDIS: mustBeNumber(),
  LALLOTH_EMPLOYMENT_NONDIS: mustBeNumber(),
  LALLOTH_NOT_SUSTAINED_NONDIS: mustBeNumber(),
  LALLOTH_NOT_CAPTURED_NONDIS: mustBeNumber(),
  LALLOTH_OVERALLPER_NONDIS: mustBePercentage(),
  LALLOTH_APPRENPER_NONDIS: mustBePercentage(),
  LALLOTH_EDUCATIONPER_NONDIS: mustBePercentage(),
  LALLOTH_FEPER_NONDIS: mustBePercentage(),
  LALLOTH_HEPER_NONDIS: mustBePercentage(),
  LALLOTH_OTHER_EDUPER_NONDIS: mustBePercentage(),
  LALLOTH_EMPLOYMENTPER_NONDIS: mustBePercentage(),
  LALLOTH_NOT_SUSTAINEDPER_NONDIS: mustBePercentage(),
  LALLOTH_NOT_CAPTUREDPER_NONDIS: mustBePercentage(),
});
